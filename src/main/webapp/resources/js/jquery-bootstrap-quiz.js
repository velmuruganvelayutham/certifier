...
//		            $completeBtn.off().on("click", $.proxy(this.complete, this))
				...
				initModalTable:function(name){
					var modalTable=['<table data-pagination="true"  data-sort-name="q"  data-sort-order="desc" data-sortable="true" data-search=true  data-click-to-select=true data-select-item-name="radioName" class="j-boot-quiz-',sprintf("%s",name),'-table"  data-show-refresh="true" data-show-toggle="true"  data-show-columns="true" data-toolbar="#toolbar">',
    					'<thead>',
    					'<tr>',
        				'<th data-field="id" data-radio="true" >Q.No</th>',
        				'<th data-field="q">Marked</th>',
        				'<th data-field="a" data-sortable="true" >Attempt</th>',
						'<th data-field="q" data-sortable="true" >Result</th>',
        				'<th data-field="a" data-sortable="true" >Exam Objective</th>',
						'<th data-field="q" data-sortable="true" >Difficulty Level</th>',
        				'<th data-field="a" data-sortable="true" data-formatter="nameFormatter" data-events="mouseoverEvent">Problem Statement</th>',
						'<th data-field="q" data-sortable="true" >Note</th>',
						'</tr>',
						'</thead>',
						'</table>'];
